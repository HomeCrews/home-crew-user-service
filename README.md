...
|---|---|
| Port | 8081 |
| Route through the gateway | `/users/**` |
| Java package | `com.homecrew.userservice` |
| Maven artifact | `userservice` |
| Image | `mthanuj/homecrew-user-service:dev` |
| Compose service | `user-service` |
| Database | `homecrew_user` |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-user-service:dev
    mthanuj/homecrew-user-service:sha-<short>
